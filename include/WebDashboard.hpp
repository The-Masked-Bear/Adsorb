  ...
  <header class="neo-card header">
    <div class="brand-wrap">
      ...
      <div class="brand-text">
        ...
        <div class="sub">Zero Ads Allowed. Deal With It. &bull; ESP32-S3 Dual-Core LX7 @ 240MHz &bull; 8MB Octal PSRAM &bull; v1.3.1 &bull; HW TRNG Parallel UDP &bull; RFC 8484 DoH</div>
      </div>
    </div>
    <div class="toolbar">
